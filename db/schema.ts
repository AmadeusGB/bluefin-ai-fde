...
export const diagnosticApplications = sqliteTable(
  "diagnostic_applications",
  {
    ...
    annualLossRange: text("annual_loss_range"),
    dataReadiness: text("data_readiness"),
    ownerReadiness: text("owner_readiness"),
...
export const evidenceRecords = sqliteTable(
  "evidence_records",
  {
    ...
    clientAuthorized: integer("client_authorized").notNull().default(0),
    clientBackground: text("client_background"),
    originalProcess: text("original_process"),
    quantifiedLoss: text("quantified_loss"),
    dataScope: text("data_scope"),
    whyOrdinaryFailed: text("why_ordinary_failed"),
    diagnosis: text("diagnosis"),
    mvdScope: text("mvd_scope"),
    humanSystemBoundary: text("human_system_boundary"),
    baselineResults: text("baseline_results"),
    risksLimitations: text("risks_limitations"),
    handover: text("handover"),
    reusableAssets: text("reusable_assets"),
    sourceReferences: text("source_references"),
    reviewer: text("reviewer"),
    completeness: integer("completeness").notNull().default(0),
  },
  (table) => [index("idx_evidence_records_updated_at").on(table.updatedAt)],
);
