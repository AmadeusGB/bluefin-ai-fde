      ...
      <main>
        ...
        <section className="px-5 py-20 lg:px-10">
          <div className="mx-auto grid max-w-[1300px] gap-12 lg:grid-cols-[.8fr_1.2fr]">
            <div>
              <p className="eyebrow text-primary">进入条件</p>
        ...
        <section className="bg-secondary px-5 py-20 lg:px-10">
          <div className="mx-auto max-w-[1300px]">
            <p className="eyebrow text-primary">交付物</p>
        ...
        <section className="px-5 py-20 lg:px-10">
          <div className="mx-auto max-w-[1300px]">
            ...
            <div className="mt-16 grid gap-8 lg:grid-cols-2">
              <div>
                <p className="eyebrow text-primary">企业需要投入</p>
              ...
              <div className="bg-muted p-8">
                <p className="eyebrow text-[#efad90]">明确不包含</p>
                <div className="mt-6 space-y-4">
                  {exclusions.map((item) => (
                    ...
                    >
                      <X className="mt-1 size-5 shrink-0 text-[#efad90]" />
                      {item}
                    </p>
                  ))}
                </div>
          ...
          <div className="mx-auto flex max-w-[1300px] flex-col justify-between gap-8 lg:flex-row lg:items-center">
            ...
            <div className="flex flex-wrap gap-3">
              <Button
                nativeButton={false}
                render={<Link href="/apply?source=field-diagnostic" />}
                className="h-13 rounded-none bg-secondary px-6 text-foreground hover:bg-secondary"
              >
              ...
              <Button
                ...
                variant="outline"
                className="h-13 rounded-none border-white/30 bg-transparent text-white hover:bg-card hover:text-foreground"
              >
                了解下一阶段 MVD
              </Button>
            </div>
