  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="bg-muted px-5 py-20 lg:px-10">
          <div className="mx-auto max-w-[1300px]">
            <div className="mb-10 max-w-3xl">
              <p className="eyebrow text-primary">方法与核验口径</p>
            ...
            {fiveMaps.map((map, i) => (
              ...
              >
                ...
                <div>
                  <b className="text-sm text-primary">核心问题</b>
                  <p className="mt-2 leading-7 text-muted-foreground">
                    {map.question}
                  </p>
                </div>
                <div>
                  <b className="text-sm text-primary">必须产出</b>
