        ...
        <section className="mx-auto grid min-h-[calc(100vh-72px)] max-w-[1500px] grid-cols-1 gap-16 px-5 pb-10 pt-16 lg:grid-cols-[1.35fr_.65fr] lg:items-center lg:px-10">
          <div>
            ...
            <p className="mt-9 max-w-3xl text-lg leading-8 text-muted-foreground lg:text-xl">
              蓝旗鱼进入真实业务现场，找到最贵的问题，用真实数据跑通最小可行部署，并把结果沉淀成企业能够长期使用的系统与能力。
            </p>
            <div className="mt-10 flex flex-wrap items-center gap-6">
              <Button
                ...
                size="lg"
                className="h-13 rounded-none px-6 text-base font-bold"
              >
                先做适配度评估 <ArrowRight />
              </Button>
              <Link
          ...
          <div className="self-end lg:pb-16">
            <div className="border border-foreground/15 p-7">
              ...
              <div className="mt-5 flex flex-col gap-2 text-2xl font-extrabold">
                <span className="decoration-[#ff735d] line-through decoration-2">
                  Demo
                </span>
                <span className="decoration-[#ff735d] line-through decoration-2">
                  泛泛培训
          ...
          <div className="mx-auto max-w-[1500px]">
            <div className="grid gap-10 lg:grid-cols-2">
              ...
              <p className="self-end text-lg leading-8 text-muted-foreground">
                先完成适配度评估和五张地图，再用 MVD
                设计器写清楚真实数据、人机边界与成功条件。工具本身免费，结论不替代现场核验。
              </p>
            </div>
