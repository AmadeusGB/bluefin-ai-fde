...
const sections = [
  ...
  [
    "首次来源信息",
    "浏览器会在当前会话的 sessionStorage 中保存首次落地路径、外部引荐 URL 和 UTM 活动参数，并在用户主动提交表单时一并保存。本站不会因此记录完整浏览历史。",
  ],
  [
    "匿名漏斗计数",
    "为计算诊断与申请转化，本站按日期、事件、站内来源和页面路径汇总记录诊断开始、携带报告申请、申请页打开和申请成功次数。应用数据库不为这些计数保存访客 ID、IP、设备信息、Cookie 或逐次行为记录；浏览器只在当前会话中保存去重标记。",
  ],
  [
    "不应提交什么",
  ...
  [
    "政策版本",
    "当前版本：2026-09-01-v1.1。表单会记录同意时间和政策版本。收集目的、字段或共享方式实质变化时，将更新本页和版本号。",
  ],
];
  ...
  return (
    <>
      ...
      <main>
        ...
        <PageHero
          eyebrow="数据治理 · 版本 2026-09-01-v1.1"
