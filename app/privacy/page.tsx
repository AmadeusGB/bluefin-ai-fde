...
export const metadata: Metadata = {
  title: "隐私与数据处理政策",
  description:
    "蓝旗鱼 AI 对诊断申请、联系方式、业务问题、诊断结果与首次来源数据的收集、使用、保存和权利请求规则。",
  alternates: { canonical: "/privacy" },
};
const sections = [
  [
    "收集哪些信息",
    "申请表收集姓名、企业或组织、联系方式、角色、行业或场景及业务问题；如果从适配度评估进入，还会保存分数、决定和 12 项是/否编码。",
  ],
  [
    "为什么处理",
  ...
  [
    "政策版本",
    "当前版本：2026-09-01-v1.0。表单会记录同意时间和政策版本。收集目的、字段或共享方式实质变化时，将更新本页和版本号。",
  ],
];
  ...
  return (
    <>
      ...
      <main>
        ...
        <PageHero
          eyebrow="数据治理 · 版本 2026-09-01-v1.0"
