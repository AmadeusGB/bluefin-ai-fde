...
export function DiagnosticTool() {
  ...
  const summary=`FDE 适配度 ${score}/100，结论 ${result[0]}；最低维度：${weakest.label} ${weakest.score}/100。`;
